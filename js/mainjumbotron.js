...
$('.statusbar ul li .dot').on('click', function(e) {
    ...
    for(var i = 0; i < imgs_count; i++) {
        ...
        $(`.main-jumbotron .slideshow li:nth-child(${i+1}) .text h1`).css('margin-left', '100px');
        $(`.main-jumbotron .slideshow li:nth-child(${i+1}) .text div`).css('margin-left', '100px');
        $(`.main-jumbotron .slideshow li:nth-child(${i+1}) .text .more-btn`).css('margin-left', '100px');
        $(`.main-jumbotron .slideshow li:nth-child(${i+1}) .text span`).css('margin-left', '100px');
    }
    ...
    $(`.main-jumbotron .slideshow li:nth-child(${idx}) .text span`).animate({marginLeft: 0}, 500);
    imgs_position = idx;
    viewStatusBar();
